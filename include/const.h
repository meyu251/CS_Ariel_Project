...
# define MAX_OUTPUT_BUFFER_LENGTH	(1024*1024*640) // 64M since it will be single precision buffer will take max 256MB memory
...
#define M0					(1.268e-6)	// 1.0023e-6[g/cm^2] Const factor of the Basilar Membrane mass density per unit area
...
#define W_OW				2*PI*1500 //2*PI*1000		// [rad] Middle ear angular frequency
...
#define Const_JND_Delta_Alpha_Time_Factor 0.1451
