...
/*! An calculation of resonse of Parks-McClellan filter at omega(number between 0 and one to represent frequencies between 0 and Pi)
* @param[in] pmo the filter structure
* @param[in] omega number between 0 and one to represent frequencies between 0 and Pi
*/
