...
// adding Astop for equivalent of dstop in matlab relevant for the stop band in any of the filter desired magnitude
void NewParksMcClellan(double *FirCoeff, int NumTaps, TFIRPassTypes PassType, double OmegaC, double BW, double ParksWidth,double Wpass,double Wstop)
{
