function [OHC0 VecIHC cTs Gain OHCloss]= FindHCfromAudio(Audio,Nf)
...
%     CFx(At)=0.015;
    ...
    [JND0]  = CalculateJNDfiles2(f,noise,...
                 run_time,En,testedPowerLevels,0.5, IHC_Vector);
    Gain=(min(JND0-JNDref,100))';
   
     [JND0]  = CalculateJNDfiles2(f,noise,...
                 run_time,En,testedPowerLevels,OHC_Vector, 8);
    OHCloss=(min(JND0-JNDref,100))';
