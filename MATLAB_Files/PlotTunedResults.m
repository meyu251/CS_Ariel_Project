...
%subplot(5,1,[1,2])
    ...
    semilogx(TestFreq,-Gain(sub,:)-OHCloss(sub,:),'b--','LineWidth',2)
    semilogx(TestFreq,OHCloss(sub,:)-JND,'g--','LineWidth',2)
     %semilogx(TestFreq,-OHCloss(sub,:),'m--','LineWidth',2)
...
%title(['Age ' num2str(Ages(j))])
    legend('Measured','Simulated Audiogram','Predicted IHC Audiogram',...
    'Location','SouthWest')
